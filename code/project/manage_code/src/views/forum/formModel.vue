                ...
                <el-row v-if="form.parentid">
                    ...
                    <el-col :span="24">
                        <el-form-item label="评论内容" prop="content">
                            <editor :value="form.content" placeholder="请输入帖子内容" :readonly="!isAdd||disabledForm.content?true:false"
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.content = res.data.data.content?(res.data.data.content.replace(reg,'../../../project/file')):'';
