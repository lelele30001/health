...
public class AIChatService {
    ...
    private static final String MODEL = "glm-4-flash"; // 永久免费模型，无限Token
    ...
    public String chatWithHistory(String message, List<Map<String, String>> history) {
        ...
        for (int attempt = 1; attempt <= maxRetries; attempt++) {
            try {
                System.out.println("===== AI Chat Debug (Attempt " + attempt + "/" + maxRetries + ") =====");
                ...
                if (history != null) {
                    for (Map<String, String> h : history) {
                        ...
                        // 过滤掉错误信息
                        if (content != null && !content.contains("AI 服务") && !content.contains("HTTP错误") && !content.contains("API Error")) {
                ...
                if (response.getStatus() == 200) {
                    ...
                    // 429错误：请求过多，重试
                    System.err.println("429 Too Many Requests - Retrying in " + retryDelay + "ms...");
