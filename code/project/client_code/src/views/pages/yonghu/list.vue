        ...
        <div class="data_view">
          ...
          >
            <div
              ...
              @click.stop="preViewClick(item.touxiang)"
            >
              <el-image
                class="data_img"
                :src="item.touxiang"
            ...
            <div
              ...
              v-else
              @click.stop="
                preViewClick($config.url + item.touxiang.split(',')[0])
              "
            >
              <el-image
                class="data_img"
                :src="
                  item.touxiang ? $config.url + item.touxiang.split(',')[0] : ''
                "
                fit="cover"
              ></el-image>
            </div>
...
const detailClick = (id) => {
  router.push(
    `${tableName}Detail?id=` + id + (centerType.value ? "&&centerType=1" : ""),
  );
};
//下载文件
const download = (file) => {
